...
flowchart TD
    ...
    classDef encStyle fill:#F5F3FF,stroke:#7C3AED,stroke-width:2px,color:#5B21B6,rx:6px,ry:6px,font-size:50px,font-weight:bold;
    classDef pinnStyle fill:#ECFDF5,stroke:#059669,stroke-width:2px,color:#047857,rx:6px,ry:6px,font-size:50px,font-weight:bold;
    classDef outStyle fill:#FFFBEB,stroke:#D97706,stroke-width:2px,color:#B45309,rx:6px,ry:6px,font-size:50px,font-weight:bold;
    classDef phyStyle fill:#FFF1F2,stroke:#E11D48,stroke-width:2px,color:#BE123C,rx:6px,ry:6px,font-size:50px,font-weight:bold;
